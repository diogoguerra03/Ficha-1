...
import aed.modelo.contactos.GestorContactosOtimizadoContinuacao;
...
public class MainPraticaGestorContactosOtimizadoContinuacao {
    ...
    public static void main(String[] args) {
        ...
        for (Contacto contacto : contactosOriginais) {
            GestorContactosOtimizadoContinuacao.INSTANCIA.inserir(contacto);
        }

        long numeroTelefone1 = 990000000;
        System.out.println("Contacto com o núm. de telefone: " + numeroTelefone1);
        System.out.println(GestorContactosOtimizadoContinuacao.INSTANCIA.consultar(numeroTelefone1));

        GestorContactosOtimizadoContinuacao.INSTANCIA.remover(numeroTelefone1);

        Data data1 = new Data(18, 3, 1994);

        System.out.println("Moradas da data: " + data1);
        for (String morada : GestorContactosOtimizadoContinuacao.INSTANCIA.consultarMoradas(data1)) {
            System.out.println(morada);
        }

        System.out.println("Contactos da data: " + data1);
        for (Contacto contacto : GestorContactosOtimizadoContinuacao.INSTANCIA.consultar(data1)) {
            System.out.println(contacto);
        }

        Data data2 = new Data(15, 6, 2000);
        System.out.println("Contactos entre a data: " + data1 + " e a data: " + data2);
        for (Contacto contacto : GestorContactosOtimizadoContinuacao.INSTANCIA.consultar(data1, data2)) {
            System.out.println(contacto);
        }

        Data data3 = new Data(10, 1, 2000);
        System.out.println("Contactos da data: " + data3);
        for (Contacto contacto : GestorContactosOtimizadoContinuacao.INSTANCIA.consultar(data3)) {
            System.out.println(contacto);
        }

        Data data4 = new Data(11, 2, 2000);
        System.out.println("Contactos entre a data: " + data3 + " e a data: " + data4);
        for (Contacto contacto : GestorContactosOtimizadoContinuacao.INSTANCIA.consultar(data3, data4)) {
            System.out.println(contacto);
        }

        Data data5 = new Data(25, 11, 1845);
        System.out.println("Contactos entre a data: " + data5 + " e a data: " + data2);
        for (Contacto contacto : GestorContactosOtimizadoContinuacao.INSTANCIA.consultar(data5, data2)) {
            System.out.println(contacto);
        }

        String morada1 = "Praça do Almada";
        System.out.println("Contactos da data: " + data1 + " com a morada: " + morada1);
        for (Contacto contacto : GestorContactosOtimizadoContinuacao.INSTANCIA.consultar(data1, morada1)) {
            System.out.println(contacto);
        }

        GestorContactosOtimizadoContinuacao.INSTANCIA.remover(data1);
        System.out.println("Contactos da data: " + data1);
        for (Contacto contacto : GestorContactosOtimizadoContinuacao.INSTANCIA.consultar(data1)) {
            System.out.println(contacto);
        }
        ...
        for (Contacto contacto : GestorContactosOtimizadoContinuacao.INSTANCIA.consultar(contactoARemover.getDataNascimento())) {
            System.out.println(contacto);
        }

        GestorContactosOtimizadoContinuacao.INSTANCIA.remover(contactoARemover);
